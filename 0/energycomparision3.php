        ...
        function updateComparisonChart(data) {
            ...
            switch (data.timePeriod.current.start.split(' ')[0]) {
                ...
                case data.timePeriod.previous.start.split(' ')[0]:
                    ...
                    currentData = new Array(days).fill(0);
                    previousData = new Array(days).fill(0);
                ...
                default:
                    // Custom range
                    labels = Array.from(new Set([...mainSupplyCurrent, ...mainSupplyPrevious].map(record => record.date_time.split(' ')[0]))).sort();
                    currentData = new Array(labels.length).fill(0);
                    previousData = new Array(labels.length).fill(0);
